exports = Paykoun.createWorker('UniqueWorkerName', {
  ...
  * The specific event will be available inside the 'job' object as : job.eventName
  * 
  * @see work
  * @see recurrence
  *<
  ...
  */
  triggers: function(){ // This can also be directly a array or a string instead of a function
    return ['eventName1', 'eventName2'];
  },

  /*
  * This declare the recurence of the job it it is a recurrent job.
  ...
  */
  ...
  /*
  * This fonction is triggered whenever a new job has to be done
  * 
  * @job  An object containing the job to be done. Contains any metadata needed
  * @done a callback to be ran when we are done doing the job
  *       This param is optional, if the fonction doesn't declare this param, it is assumed
  ...
  * We will be able to specify the ressources we want a worker to take from a dynamicaly.
  * In this way, whenever a specifc part of our system is buggy or failing we will be able to point to it.
